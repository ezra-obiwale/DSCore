...
class TwBootstrap3 {
     ...
     * @return string
     */
    public static function createAlert($type, $message, $class = null,
            $closable = true) {
        ob_start();
        ?>
     ...
     * @return string
     */
    public static function popover($content, $label, $container = 'body',
            $placement = 'top', $title = null, $class = null) {
        ob_start();
        ?>
     ...
     * @return string
     */
    public static function ratings($rating, $showNumber = true,
            $useHearts = false) {
        ob_start();
        for ($i = 1; $i <= 5; $i++) {
            ?>
